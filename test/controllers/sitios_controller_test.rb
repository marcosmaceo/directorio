...
class SitiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sitio" do
    assert_difference('Sitio.count') do
      post sitios_url, params: { sitio: { descripcion: @sitio.descripcion, direccion: @sitio.direccion, ip: @sitio.ip } }
    end
  ...
  test "should update sitio" do
    patch sitio_url(@sitio), params: { sitio: { descripcion: @sitio.descripcion, direccion: @sitio.direccion, ip: @sitio.ip } }
